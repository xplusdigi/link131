...
const BrandCard = ({ 
  ...
  return (
    <div className={`bg-white rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow duration-300 overflow-hidden ${className}`}>
      {/* 卡片头部 - Logo和徽章 */}
      ...
      <div className="px-6 pb-4">
        ...
        {/* 品牌URL */}
        <p className="text-sm text-blue-600 mb-3 text-center break-all">
          {brand.url}
        </p>
        ...
        <div className="flex flex-col space-y-2">
          ...
          <div className="flex space-x-2">
            ...
            <Link
              ...
              className="flex-1 flex items-center justify-center px-3 py-2 bg-gray-200 text-gray-700 hover:bg-gray-300 rounded-lg font-medium transition-colors"
              title="View details"
            >
